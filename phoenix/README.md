...
> **本地仓库说明**：本目录同时包含两套代码。其一是本 README 描述的上游
...
> `services/`，为 `home-mixer::PhoenixCandidatePipeline` 提供 gRPC 模型服务，macOS 可运行），
> 其文档见 [`../docs/implementation/slim-phoenix-recommendation.md`](../docs/implementation/slim-phoenix-recommendation.md)。两套代码
