...
> Absorbed upstream anchor: `902a06fd616ed815f660e5546d16d492fa1ca825` (2026-09-04 snapshot; range inventory in [`902a06f-capability-inventory.md`](./902a06f-capability-inventory.md), outcome in [`../update/20260907.md`](../update/20260907.md); two behaviour-neutral Phoenix alignments only — SID snapshot path construction and structured `extra=` log rendering; the MoE co-divert changes to `author_cold_start.rs` have no local landing point)
> Upstream head: `902a06fd616ed815f660e5546d16d492fa1ca825`
>
...
git diff --find-renames 902a06fd616ed815f660e5546d16d492fa1ca825..<new-upstream> -- <module>
