use super::blender_selector::BlenderConfig;
use super::feed_item::FeedItem;
use super::feed_state::{FeedStateStore, InMemoryFeedStateStore};
use super::feed_stats::{FeedStatsSink, LoggingFeedStats};
use super::for_you_candidate_pipeline::ForYouCandidatePipeline;
use super::scored_posts_source::ScoredPostsProvider;
...
impl ForYouFeedServer {
    pub fn new(scored_posts_server: Arc<ScoredPostsServer>) -> Self {
